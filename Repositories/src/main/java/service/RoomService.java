...
public class RoomService {
    ...
    public List < Room > getFreeRooms(int sortIndex) { //получить свободные комнаты
    ...
    public List < Room > getRooms(Integer sortIndex) { //получить комнаты
        return sortingNavigator.roomSort(sortIndex);
    }


    public Room addRoom(Room room) { //добавить комнату
    ...
    public Room updateRoom(int number, Room room) { //обновить комнату
    ...
    public Room getRoom(int number) {  //получить комнату
